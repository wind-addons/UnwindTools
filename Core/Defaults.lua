...
E:AddGeneralSettings({
	locale = {
		...
		values = {
			deDE = F.Color.String("deDE", "amber-400") .. " - Deutsch",
			enUS = F.Color.String("enUS", "amber-400") .. " - English",
			esES = F.Color.String("esES", "amber-400") .. " - Español (España)",
			esMX = F.Color.String("esMX", "amber-400") .. " - Español (Latinoamérica)",
			frFR = F.Color.String("frFR", "amber-400") .. " - Français",
			itIT = F.Color.String("itIT", "amber-400") .. " - Italiano",
			koKR = F.Color.String("koKR", "amber-400") .. " - 한국어",
			ptBR = F.Color.String("ptBR", "amber-400") .. " - Português (Brasil)",
			ruRU = F.Color.String("ruRU", "amber-400") .. " - Русский",
			zhCN = F.Color.String("zhCN", "amber-400") .. " - 简体中文",
			zhTW = F.Color.String("zhTW", "amber-400") .. " - 繁體中文",
		},
		get = function()
